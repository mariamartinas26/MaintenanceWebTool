...
CREATE TABLE IF NOT EXISTS "AccountRequests" (
    ...
    CONSTRAINT check_role CHECK (role IN ('client', 'admin', 'contabil')),
    CONSTRAINT check_status CHECK (status IN ('pending', 'approved', 'rejected')),
    CONSTRAINT check_rejection_reason CHECK (rejection_reason IN ('incomplete', 'invalid', 'duplicate', 'policy', 'other'))
    );
